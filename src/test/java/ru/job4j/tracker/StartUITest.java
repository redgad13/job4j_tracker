...
public class StartUITest {
    ...
    public void whenShowAllActionTestOutputIsSuccessfully() {
        ...
        MemTracker tracker = new MemTracker();
        Item one = tracker.add(new Item("test1"));
        String findAll = String.valueOf(one.getId());
        Input in = new StubInput(
                new String[]{"0", String.valueOf(one.getId()), findAll, "1"}
        );
        List<UserAction> actions = new ArrayList<>();
    ...
    public void whenFindByIDActionTestOutputIsSuccessfully() {
        ...
        MemTracker tracker = new MemTracker();
        Item one = tracker.add(new Item("test1"));
        String findByID = String.valueOf(one.getId());
        Input in = new StubInput(
                new String[]{"0", String.valueOf(one.getId()), findByID, "1"}
        );
        List<UserAction> actions = new ArrayList<>();
